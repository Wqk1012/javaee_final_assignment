...
public interface BorrowRecordMapper {
    ...
    //删除借阅记录
    int deleteBorrowRecord(@Param("borrowRecordId") Integer borrowRecordId);
    //增加借阅记录
    int addBorrowRecord(Integer bookId,Integer userID);
    //归还图书
    int returnBorrowedBook(@Param("borrowRecordId") Integer borrowRecordId);
    // 查询某个用户借阅的所有图书(多表)
